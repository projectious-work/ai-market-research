...
**Status:** pending
**aibox CLI:** v0.28.4 → v0.28.12
**processkit:** v0.28.1

## Summary

aibox has been updated from v0.28.4 to v0.28.12. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.28.4 and v0.28.12 is listed below.                  Review each; treat entries tagged as breaking as action items.
