...
**Status:** pending
**aibox CLI:** v0.28.12 → v0.28.14
**processkit:** v0.28.4

## Summary

aibox has been updated from v0.28.12 to v0.28.14. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.28.12 and v0.28.14 is listed below.                  Review each; treat entries tagged as breaking as action items.
