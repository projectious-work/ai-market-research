...
**Status:** pending
**aibox CLI:** v0.28.19 → v0.31.0
**processkit:** v0.28.5

## Summary

aibox has been updated from v0.28.19 to v0.31.0. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.28.19 and v0.31.0 is listed below.                  Review each; treat entries tagged as breaking as action items.
