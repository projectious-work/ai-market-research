...
**Status:** pending
**aibox CLI:** v0.31.0 → v0.32.6
**processkit:** v0.28.5

## Summary

aibox has been updated from v0.31.0 to v0.32.6. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.31.0 and v0.32.6 is listed below.                  Review each; treat entries tagged as breaking as action items.
