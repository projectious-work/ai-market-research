...
**Status:** pending
**aibox CLI:** v0.33.2 → v0.34.1
**processkit:** v0.28.8

## Summary

aibox has been updated from v0.33.2 to v0.34.1. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.33.2 and v0.34.1 is listed below.                  Review each; treat entries tagged as breaking as action items.
