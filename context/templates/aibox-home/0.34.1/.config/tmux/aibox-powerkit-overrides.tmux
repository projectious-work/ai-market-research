...
# render pass.
set -g pane-border-style "fg=#949F97,bg=#2D353B"
set -g pane-active-border-style "fg=#7FBBB3,bg=#2D353B"
set -g pane-border-format "#[bg=#2D353B]#{?pane_active,#[fg=#7FBBB3]#[bold],#[fg=#C3BCA5]#[dim] } #{?client_prefix,PREFIX,NORMAL} #{pane_title} #{pane_current_command} #[bg=#2D353B,fg=#2D353B] "
