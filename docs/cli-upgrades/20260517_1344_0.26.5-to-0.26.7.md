...
- [ ] Verify `/workspace/context/templates/processkit/v0.26.13/` snapshot directory exists
...
- [ ] Check `/workspace/context/migrations/pending/` for processkit content migration files:
      ...
      - **When reviewing template files like `AGENTS.md`:** do NOT diff the installed
        ...
        `diff context/templates/processkit/v0.26.13/AGENTS.md context/templates/processkit/v0.26.13/AGENTS.md`
...
processkit is pinned to `v0.26.13` (source: `https://github.com/projectious-work/processkit.git`).
...
- [ ] processkit version reference matches `aibox.lock` (`v0.26.13`)
